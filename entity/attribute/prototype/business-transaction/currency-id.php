...
use MsPhp\Entity\Attribute\Prototype\Currency\Code;
...
class CurrencyId extends AttributeNumericType {
    public function __construct() {
        ...
        $this->setName('currency_id')
            ...
            ->addQuality((new QualityMaxValue())->setShallValue(50))
