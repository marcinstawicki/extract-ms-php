...
use MsPhp\Entity\Attribute\Prototype\VocabularyClassification\Identifier;
...
class VocabularyClassificationId extends AttributeNumericType {
    public function __construct() {
        ...
        $this->setName('vocabulary_classification_id')
