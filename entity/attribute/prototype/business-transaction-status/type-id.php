<?php
namespace MsPhp\Entity\Attribute\Prototype\BusinessTransactionStatus;

use MsPhp\App\Process\Access;
use MsPhp\Entity\Attribute\AttributeNumericType;
use MsPhp\Entity\Attribute\ForeignKey;
use MsPhp\Entity\Attribute\Prototype\Common\BusinessTransactionStatusType;
...
class TypeId extends AttributeNumericType {
    public function __construct() {
        $foreignKey = (new ForeignKey())
            ->setReference(new BusinessTransactionStatusType())
